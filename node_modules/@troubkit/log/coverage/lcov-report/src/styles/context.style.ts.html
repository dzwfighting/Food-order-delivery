...
<head>
    <title>Code coverage report for src/styles/context.style.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/styles</a> context.style.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >                        context = {0: PrintableToString(args[0] as Printable)};</span>
